...
A Tableau project that creates meaningful visualizations to analyse of an e-commerce company's (Shopzilla's) customer support performance.
...
- **Important fields:**
  - `Isse reported at` - timestamp when ticket was issued
